...
import { fetchNews, deleteNews, clearError, clearSuccess } from '@/lib/slices/newsSlice'
...
export default function NewsPage() {
  ...
  const { news, isLoading, isDeleting, error, success } = useAppSelector((state) => state.news)
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  ...
                  <th className="text-left py-3 px-4 font-medium text-gray-900 dark:text-white">Event Date</th>
                ...
                {filteredNews.map((newsItem) => (
                  <tr key={newsItem._id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800">
                    ...
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">
                      {formatDateTime(newsItem.eventAt)}
                    </td>
                    <td className="py-3 px-4">
