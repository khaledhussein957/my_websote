...
import { registerAccountValidate, loginAccountValidate, forgotPasswordValidate, resetPasswordValidate, } from "../middlewares/authValidate.middleware.ts";
import { authMiddleware } from "../middlewares/protectRoute.ts";
import { registerAccount, loginAccount, checkAuth, logout, forgotPassword, resetPassword, } from "../controllers/auth.controller.ts";
