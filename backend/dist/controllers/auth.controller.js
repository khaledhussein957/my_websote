...
import {} from "../middlewares/protectRoute.ts";
import { forgotPasswordEmail, sendPasswordResetSuccessEmail, } from "../emails/emailHandlers.ts";
...
export const forgotPassword = async (req, res) => {
    try {
        ...
        try {
            await forgotPasswordEmail(user.name, resetCode, ENV.CLIENT_URL, user.email);
            res
                .status(200)
