...
import { FORGOT_PASSWORD_EMAIL_TEMPLATE, PASSWORD_RESET_SUCCESS_TEMPLATE, } from "../emails/emailTemplate.ts";
export const forgotPasswordEmail = async (name, email, resetCode, clientURL) => {
