...
export const updateProfile = createAsyncThunk(
  ...
  async (profileData: UpdateProfileData, { rejectWithValue }) => {
    try {
      ...
      if (profileData.about_me) formData.append('about_me', profileData.about_me)
...
export const { clearError, clearSuccess, clearMessages, setCurrentUser } = userSlice.actions
