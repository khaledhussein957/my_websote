...
export function SkillsSection() {
  ...
  // Always use techStacks.data as the array, never treat techStacks as an array
  const techStackList = Array.isArray(techStacks?.data) ? techStacks.data : [];
  // Never use techStacks as an array directly in this file
                        ...
                        >
                          ...
                          <div className="w-full bg-muted rounded-full h-1 mt-2">
                            <motion.div
                              ...
                              initial={{ width: 0 }}
                              whileInView={{ width: `${(skill.proficiency || 0) * 10}%` }}
                              viewport={{ once: true }}
